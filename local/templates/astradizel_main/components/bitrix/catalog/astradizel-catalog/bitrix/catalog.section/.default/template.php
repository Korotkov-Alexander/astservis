...
<? } ?>
    ...
    //Функция для ресайза изображений
        function ResizeImage($imageR)
        {
            $image = CFile::GetFileArray($imageR);
                    ...
                    <div class="col-sm-2">
                        <div class="table-photo">
                            <a id="<? echo $arItemIDs['PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" title="<? echo $imgTitle; ?>">
                                <img src="<? echo ResizeImage($arItem['PREVIEW_PICTURE']['ID']); ?>" alt="<? echo $imgTitle; ?>">
                            </a>
                        </div>
                    </div>
